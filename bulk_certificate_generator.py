...
# The base title (Participant Name) font size is dynamically set to 3.5% of the template's width.
# Later in the code, a smart scaling rule reduces this size by 12% if the name exceeds 30 characters.
# ==============================================================================
...
# The precise position uses relative percentages calculated from the image size:
# - X (width * 0.573): Places the title text anchor exactly at 57.3% of the image width.
# - Y (height * 0.408): Places the title text anchor exactly at 40.8% of the image height.
# In the generation loop, `anchor="mm"` is used to perfectly center the text around these exact coordinates.
# ==============================================================================
